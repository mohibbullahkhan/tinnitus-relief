...
//               <p
//                 className="text-[15px] leading-none text-white m-0 tracking-[0.01em]"
...
//               {/* Arrow slider track */}
//               <div className="relative flex items-center w-[120px] h-[2px] bg-[#4a6a3a]">
...
//             {/* ── best in headphones ── */}
//             <p
//               className="text-[9.5px] leading-none text-[#7abf50] m-0 mb-3 tracking-[0.01em]"
...
//             <p
//               className="text-[11px] leading-[1.6] text-[#c8d0b8] m-0 mb-1"
//               style={{ fontFamily: "var(--font-seravek)", fontWeight: 400 }}
//             >
...
//                 <li
//                   key={i}
//                   className="flex items-start gap-1.5 text-[10.5px] leading-[1.6] text-[#a8b898]"
        ...
        <div className="col-span-3 flex items-start gap-8 pl-20 pr-0 pt-6 pb-8">
          ...
          <div className="flex flex-col items-start min-w-0 flex-1">
            ...
            <div className="flex items-center gap-4 mb-1">
              <p
                className="text-[32px] leading-none text-black m-0 tracking-tight lowercase"
                style={{ fontFamily: "var(--font-kallisto)", fontWeight: 700 }}
              >
                take a listen:
              </p>
              ...
              {/* Arrow slider track */}
              <div className="relative flex items-center w-[180px] h-[4px] bg-[#4a6a3a]">
            ...
            {/* ── best in headphones ── */}
            <p
              className="text-[15px] leading-none text-[#9DFF00] m-0 mb-4 tracking-[0.01em] font-bold lowercase"
              style={{ fontFamily: "var(--font-seravek)" }}
            >
              ( best in headphones or ear buds )
            </p>
            ...
            {/* ── "as you turn up the volume..." ── */}
            <p
              className="text-[15px] leading-[1.6] text-white m-0 mb-2 font-bold lowercase"
              style={{ fontFamily: "var(--font-seravek)" }}
            >
              as you turn up the volume, you will likely notice:
            </p>
            ...
            <ul className="list-none m-0 p-0 flex flex-col gap-1.5">
              {[
                <>
                  the ringing{" "}
                  <span className="font-black underline tracking-wide">
                    disappears
                  </span>
                </>,
                "uncanny realism: full immersion to the environment",
                ...
                <li
                  key={i}
                  className="flex items-center gap-2 text-[15px] leading-[1.6] text-white font-bold lowercase"
                  style={{ fontFamily: "var(--font-seravek)" }}
                >
          ...
          <div className="flex flex-col gap-3 flex-1 min-w-0 pt-1">
            {/* Ocean Aire */}
            <div className="flex items-center gap-3 bg-[rgba(0,0,0,0.45)] border border-[rgba(100,160,80,0.25)] rounded-sm px-4 py-3.5 cursor-pointer hover:border-[rgba(100,160,80,0.5)] transition-colors group">
              <div className="w-0 h-0 border-y-[9px] border-l-[16px] border-y-transparent border-l-[#6abf4b] shrink-0 group-hover:border-l-[#8adf6b] transition-colors" />
              <p
                className="text-[15px] leading-none text-[#c8d0b8] m-0 tracking-[0.01em]"
                style={{ fontFamily: "var(--font-kallisto)", fontWeight: 500 }}
              >
                Ocean Aire :{" "}
                <span className="text-[#a0b090]" style={{ fontWeight: 400 }}>
