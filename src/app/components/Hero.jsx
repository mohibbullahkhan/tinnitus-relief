      ...
      >
        ...
        >
          ...
          <div style={{ marginBottom: "8px" }}>
            ...
            >
              <span className="font-kallisto font-[#9DFF00] " style={{ color: "#9DFF00" ,fontWeight: 900}}>750 Million people </span>
              <span className="font-kallisto font-[#9DFF00]" style={{ color: "#9DFF00", fontWeight: 700 }}>suffer from</span>
            </p>
          ...
          >
            ...
            >
              ...
              <div
                style={{
                  ...
                  borderColor: "transparent transparent transparent rgba(220,220,220,0.90)",
                  marginLeft: "6px",
                }}
              />
            </div>
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                ...
                {/* Square □ */}
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                  <rect x="1" y="1" width="10" height="10" stroke="#888" strokeWidth="1.2" rx="1" />
                </svg>
